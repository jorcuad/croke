...
description: '(Only spanish version) Data processing involves a myriad of problems, mostly in the processing phase. In this post we will talk about the solutions offered by cryptography.'
tags: ['BBVA Next', 'security', 'machine learning', 'privacy']
draft: false
title: 'Privacy in machine learning: a concept now more formal and tangible'
