...
<a href="https://github.com/microsoft/SEAL">
  Microsoft SEAL
</a>, una biblioteca de cifrado homomórfico de última generación, y TensorFlow, uno de los frameworks de \_machine learning\_ más populares. Esta librería forma parte de
<a href="https://github.com/tf-encrypted/tf-encrypted">
  TF Encrypted
</a> cuyo objetivo consiste en construir una interfaz para el \_machine learning\_ sobre datos cifrados.
