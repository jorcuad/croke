...
</a>, y actualmente proporcionan certificados a 225 millones de páginas web. Para poder emitir el certificado es necesario demostrar el control sobre dominio donde se aloja la aplicación y para ello es necesario instalar en el \_host\_ web un cliente software que emplee el protocolo
